 ...
 *
 * All 42 insights and all 9 presentations carry a genre (2026-09-13), so nothing reaches
 ...
 * artifact of an incomplete migration and unpublished it. A second artifact surfaced the
 * same day — `cs-meetup`, an `article` carrying the Presentation-branch genre "Talk" — and
 * went the same way. The corpus is being repaired while the build runs against it.
 *
